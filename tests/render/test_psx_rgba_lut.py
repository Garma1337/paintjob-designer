...
class TestPsxRgbaLut:
    ...
    def test_value_zero_is_fully_transparent(self):
        lut = PsxRgbaLut()
    ...
    def test_non_zero_values_are_fully_opaque(self):
        lut = PsxRgbaLut()

        # Any non-zero value should end up with alpha = 0xFF.
    ...
    def test_matches_color_converter_for_representative_values(self, color_converter):
        ...
        lut = PsxRgbaLut()
        probes = [0x0000, 0x0001, 0x001F, 0x03E0, 0x7C00, 0x7FFF, 0x03EB, 0x1234]
